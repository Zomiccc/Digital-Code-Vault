...
exports.DeliveryModule = DeliveryModule = __decorate([
    (0, common_1.Module)({
        imports: [webhooks_module_1.WebhooksModule, email_module_1.EmailModule],
        providers: [delivery_service_1.DeliveryService],
        controllers: [delivery_controller_1.DeliveryController, delivery_controller_1.DeliveryApiController],

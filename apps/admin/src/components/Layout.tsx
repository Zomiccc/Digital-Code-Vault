...
import {
  ...
  MessagesSquare, Tags, Mail, ShieldAlert, Coins, BadgeDollarSign,
} from 'lucide-react';
...
const adminNav = [
  ...
  { to: '/admin/presets', label: 'Delivery Rules', icon: Layers },
  ...
  { to: '/admin/prices', label: 'Prices', icon: BadgeDollarSign },

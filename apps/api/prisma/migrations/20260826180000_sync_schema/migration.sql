-- AlterTable
ALTER TABLE "ApiKey" ADD COLUMN     "ipWhitelist" TEXT NOT NULL DEFAULT '[]';
...
-- AlterTable
ALTER TABLE "CodeItem" ADD COLUMN     "merchantId" TEXT,
ADD COLUMN     "source" TEXT NOT NULL DEFAULT 'DCV';

-- AlterTable
ALTER TABLE "DeliveryToken" DROP COLUMN "expiresAt";

-- AlterTable
ALTER TABLE "Denomination" ALTER COLUMN "faceValue" SET DATA TYPE DECIMAL(65,30);

-- AlterTable
ALTER TABLE "FulfillmentRequest" ADD COLUMN     "customerAddress" TEXT,
ADD COLUMN     "customerEmail" TEXT,
ADD COLUMN     "customerName" TEXT,
ADD COLUMN     "inventorySource" TEXT DEFAULT 'DCV',
ADD COLUMN     "walletCharged" BOOLEAN NOT NULL DEFAULT false,
ALTER COLUMN "amount" SET DATA TYPE DECIMAL(65,30);

-- AlterTable
ALTER TABLE "Merchant" ADD COLUMN     "address" TEXT,
ADD COLUMN     "businessNtn" TEXT,
ADD COLUMN     "firstName" TEXT,
ADD COLUMN     "idBackImage" TEXT,
ADD COLUMN     "idDocType" TEXT,
ADD COLUMN     "idFrontImage" TEXT,
ADD COLUMN     "lastKeyGeneratedAt" TIMESTAMP(3),
ADD COLUMN     "lastName" TEXT,
ADD COLUMN     "phone" TEXT,
ADD COLUMN     "totalKeysGenerated" INTEGER NOT NULL DEFAULT 0,
ADD COLUMN     "webhookSecret" TEXT,
ALTER COLUMN "walletBalance" SET DATA TYPE DECIMAL(65,30);

-- AlterTable
ALTER TABLE "Product" ADD COLUMN     "categoryId" TEXT,
ADD COLUMN     "merchantId" TEXT,
ADD COLUMN     "productType" TEXT NOT NULL DEFAULT 'NORMAL';
